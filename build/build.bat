...
REM 64 bit build:
cl %CommonCompilerFlags% -DPROJECT21_SLOW=1 -DPROJECT21_INTERNAL=1 -Fmproject21.map ..\src\project21.cpp -LD /link /EXPORT:ApplicationUpdate /EXPORT:ApplicationGetSound
cl %CommonCompilerFlags% -DPROJECT21_SLOW=1 -DPROJECT21_INTERNAL=1 -Fmwin32_newproject21.map ..\src\win32_newproject21.cpp /link %CommonLinkerFlags% %CommonLinkerIncludes%
